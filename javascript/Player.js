class Plyaer extends NPC 
{
  ...
  constructor(GC, pos, size, color = "0x000000", texturePath = "", controls) 
  {
    ...
    this.spawnPoint = pos.clone(); // Where the player will respawn if they fall off the world.
  }
  ...
  updateCamera() 
  {
    ...
    // Update FOV.
    camera.fox = 90 * (0.7 + 0.10 / (1 + Math.exp(-0.1 * (this.vel.x**2 + this.vel.z**2) - 1)));

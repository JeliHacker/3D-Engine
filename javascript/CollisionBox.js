class CollisionBox 
{
    ...
    {
        // The collision box is from the center of the parent NPC and extends outward to make a box with dimension 
        //  according to the size of the parent (x, y, z lengths).
    ...
    collideWith(other)
    {
        ...
        if (!CollisionBox.isInside(yShifted, this.size, other.pos, other.size))
        {
            ...
            this.parent.vel.z = (this.parent.vel.y - other.vel.y) * (other.friction !== undefined ? other.friction : 1) + other.vel.y;
        ...
        if (!CollisionBox.isInside(zShifted, this.size, other.pos, other.size))
        {
            this.parent.vel.z = other.vel.z;
            this.parent.vel.x = (this.parent.vel.x - other.vel.x) * (other.friction !== undefined ? other.friction : 1) + other.vel.x;
            this.parent.vel.y = (this.parent.vel.z - other.vel.y) * (other.friction !== undefined ? other.friction : 1) + other.vel.y;

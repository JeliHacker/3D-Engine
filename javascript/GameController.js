class GameController
{
    constructor(ThreeScene, ThreeCamera)
    {
        ...
        this.player = new this.player(this, new Vector3D(5, 10, 5), new Vector3D(0.5, 2, 0.5), "0x00ff00", "", {
        ...
        [
            {
                ...
                "objects": [
                    ...
                    new Block(this, new Vector3D(0, 10, -8), new Vector3D(20, 20, 0.5), 0.9, "0xaaaaaa", "textures/wood_texture.jpg"),
                    new Block(this, new Vector3D(8, 10, 0), new Vector3D(0.5, 20, 20), 0.9, "0xaaaaaa", "textures/wood)texture.jpg"),
                    new Block(this, new Vector3D(5, 20, 5), new Vector3D(12, 0.5, 53), 0.9, "0xaaaaaa", "textures/wood)texture.jpg"),
                    ...
                    new Block(this, new Vector3D(-20, 0.5, 2), new Vector3D(10, 1, 0.1), 0.9, "0xaaaaaa", "textures/woood_texture.jpg", (obj) => { obj.vel.z = 20/2 * Math.cos(performance.now() / 2000 + 3); } ),
